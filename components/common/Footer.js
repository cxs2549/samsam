...
const navigation = {
  solutions: [
    { name: "What I'm Wearing", href: "#" },
    { name: "Who to Follow", href: "#" },
    { name: "Habits", href: "#" },
    { name: "More", href: "#" },
  ],
  support: [
  ...
  legal: [
    { name: "Overcoming Obstacles", href: "#" },
    { name: "Privacy", href: "#" },
    { name: "Boundaries", href: "#" },
  ],
  social: [
    {
      name: "Facebook",
        ...
        <div className="border-t border-gray-200 pt-8 xl:mt-0">
          ...
          <form className="mt-4 sm:flex sm:max-w-md">
            ...
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full bg-blue-300 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-semibold text-white focus:outline-none focus:ring-0 "
              >
                Subscribe
              </button>
            </div>
